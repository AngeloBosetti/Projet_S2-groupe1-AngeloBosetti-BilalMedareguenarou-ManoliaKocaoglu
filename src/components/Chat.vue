...
<template>
  <div class="p-4">
    <div class="mb-4">
      ...
      <div v-if="user" class="text-gray-500">Connecté en tant que {{ user.nickname }}</div>
    </div>
    <div class="mb-4">
